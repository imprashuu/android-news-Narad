...
import com.example.android.narad.EmptyRecyclerView;
...
import com.example.android.narad.adapter.NewsAdapter;
...
public class BaseArticlesFragment extends Fragment
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        return new Newspaper(getActivity(), uriBuilder.toString());
    }
